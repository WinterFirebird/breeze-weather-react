...
import { getLocationFromLocalStorage, getLocationFromIP, getLocationFromNavigator } from '../../utils/getLocation';
import api from '../../api';
...
class Weather extends Component {
  ...
  updateWeatherAndLocationName = () => {
    ...
    api.callWeatherApi(this.handleWeatherResponse, latitude, longitude);
    // call the reverse geocoding api only if no data is already provided 
    if(!city || !country) {
      api.callReverseGeocodingApi(this.handleReverseGeocodingResponse, latitude, longitude);
    }
  }
